...
static constexpr DWORD ACTIVE_FILTER_OPTION_FLAGS =
    FKF_AVAILABLE |
    FKF_HOTKEYACTIVE |
    FKF_CONFIRMHOTKEY |
    FKF_HOTKEYSOUND |
    FKF_CLICKON;
static constexpr DWORD WINDOW_FILTER_FLAGS =
    ACTIVE_FILTER_OPTION_FLAGS |
    FKF_INDICATOR;
static constexpr DWORD DEFAULT_ACTIVE_FILTER_FLAGS = FKF_AVAILABLE;

static_assert(ACTIVE_FILTER_OPTION_FLAGS == 94);
static_assert(WINDOW_FILTER_FLAGS == 126);
